...
class WinRateCalculate
{
    ...
    public function execute(array $attributes) :array
    {
        ...
        $fourth = isset($countBy[4]) ? round($countBy[3]/$count * 100, 2) : '-';
        $fifth = isset($countBy[5]) ? round($countBy[3]/$count * 100, 2) : '-';
        $sixth = isset($countBy[6]) ? round($countBy[3]/$count * 100, 2) : '-';
        $seventh = isset($countBy[7]) ? round($countBy[3]/$count * 100, 2) : '-';
        $eighth = isset($countBy[8]) ? round($countBy[3]/$count * 100, 2) : '-';
        $ninth = isset($countBy[9]) ? round($countBy[3]/$count * 100, 2) : '-';
        $tenth = isset($countBy[10]) ? round($countBy[3]/$count * 100, 2) : '-';
        $eleventh = isset($countBy[11]) ? round($countBy[3]/$count * 100, 2) : '-';
        $twelfth = isset($countBy[12]) ? round($countBy[3]/$count * 100, 2) : '-';
